...
[🚀 프로젝트 소개](#1-프로젝트-소개) · 
[📦 의존성](#2-의존성) · 
[🔄 실시간 동기화](#31-사용자의-상호작용에-따른-앱---웹-실시간-동기화) ·
[➕ 컴포넌트 생성](#32-웹-컴포넌트-생성) ·
[🎨 컴포넌트 커스텀](#33-웹-컴포넌트-커스텀-기능) ·
[🖱️ 드래그--선택](#34-컴포넌트-선택--드래그-기능) ·
[🧱 Layer 설정](#35-웹-컴포넌트-layer-level-설정) ·
[📁 멀티 캔버스](#36-멀티-캔버스-기능) ·
[🔗 웹페이지 제공](#37-사용자가-만든-웹페이지-링크-제공) ·
[▶️ 실행 방법](#4-실행-방법) · 
[🏗️ 아키텍처](#5-시스템-아키텍처) · 
[📜 라이선스](#6-라이선스)
##  0. 🎬 서비스 실행 화면

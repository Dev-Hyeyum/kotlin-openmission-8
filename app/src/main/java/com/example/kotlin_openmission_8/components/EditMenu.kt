...
fun EditMenu(
    ...
    val actionOptions = remember { EventType.entries.map { it.label } }
        ...
        if (component.type == ComponentType.Button) {
            ...
            DropDownMenu(
                ...
                onSelectionChange = { label ->
                    selectedActionType = EventType.entries.find { it.label == label } ?: EventType.NONE
                },
